function PrintAllEvenNumbersBetweenAGivenRange(startRange, endRange, unPrintableNumbers) {
...
window.onload = function(){    
    ...
    var amountToExclude = 5,
    startRange = 1,
    endRange = 50;
    generatedNumbers = GenerateRandomEvenNumbers(amountToExclude, startRange, endRange, []); // This array runs the GenerateRandomEvenNumbers to generate the ararys of even numbers to exclude from the printableNumbers array
